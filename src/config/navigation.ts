...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { key: 'breathing', path: '/breathing', icon: 'lucide:folder', isContentType: true, order: 3 },
  { key: 'demon-arts', path: '/demon-arts', icon: 'lucide:folder', isContentType: true, order: 4 },
  { key: 'clans', path: '/clans', icon: 'lucide:folder', isContentType: true, order: 5 },
];

...
export const site: SiteConfig = {
  name: 'slayers 2 Wiki',
  shortName: 'slayers 2',
  description: 'Complete slayers 2 wiki with guides, codes, tier lists, and tips. Every page carries a last-verified date.',
  domain: 'wasdhhhhhh.pages.dev',
  tagline: 'Your home for everything slayers 2',
  legalNotice: 'slayers 2 Wiki is a fan-made community site. Not affiliated with or endorsed by the game developer.',
  // Set a real address if you run no social channels — the contact page
  // renders it as a mailto link.
  contactEmail: '',
  social: {
    official: 'https://www.roblox.com/games/16205713724/Slayers-2',
  },
  game: {
    name: 'slayers 2',
    platform: 'Roblox',
